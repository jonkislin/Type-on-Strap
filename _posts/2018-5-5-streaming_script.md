---
layout: post
title: "A simple Twitter API Script"
excerpt_separator: "<!--more-->"
published: true
---
Tweepy StreamingAPI python script.
...
```
Alternatively, go to my [github](https://github.com/jonkislin/traverse/blob/master/code/1-twitter_stream.py)
